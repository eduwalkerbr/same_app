    ...
    <div class="card-deck" style="background-color: white;padding-top:16px;border: 1px solid white;">
        <div class="card text-center" style="box-shadow: 5px 5px 5px rgba(156,163,175);">
            <div class="card-header" style="text-align: justify;background-color: white; border-bottom:none;font-size:15px;color:black;font-weight:bold;">
                <i class="fa-solid fa-percent"></i> &emsp; Escolas do Munícipio
            </div>
            <div class="card-body" style="padding-top:0.5rem;padding-bottom:0.5rem;">
                <!---- Título Card Disciplinas Munícipio ---->
                <p class="card-text" style="font-size:13px;color:black;border-bottom:none;text-align:justify;font-weight:bold;">Seguem abaixo as Proficiências por Escola</p>
                <!---- Título Card Disciplinas Munícipio ---->
                <!------------------------------------ Cards ------------------->
                ...
                <p style="color:rgba(107,114,128);font-size: 13px;text-align:justify;margin-top:30px;">
                    * Os presentes dados representam o percentual de proficiência por Escola do Município.<br>* Caso deseje visualizar o nome completo da Escola, ponha o mouse sobre o ícone &ensp;<i class="fa-solid fa-circle-question"></i>
                </p>
