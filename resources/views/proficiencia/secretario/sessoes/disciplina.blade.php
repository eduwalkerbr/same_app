...
<div class="card text-center" style="box-shadow: 5px 5px 5px rgba(156,163,175);">
    <!---- Título Card Disciplinas Munícipio ---->
    <div class="card-header" style="text-align: justify;background-color: white; border-bottom:none;font-size:15px;color:black;font-weight:bold;">
        <i class="fa-solid fa-percent"></i> &emsp; Disciplinas
    </div>
    <!---- Título Card Disciplinas Munícipio ---->


    <div class="card-body" style="padding-top:0.5rem;padding-bottom:0.5rem;">
        <p class="card-text" style="font-size:13px;color:black;border-bottom:none;text-align:justify;font-weight:bold;">Seguem abaixo as Proficiências por Disciplina</p>
        <!------------------------------------ Cards ------------------->
        @foreach ($dados_base_disciplina as $group)
        ...
        <p style="color:rgba(107,114,128);font-size: 13px;text-align:justify;margin-top:30px;">
            * Os presentes dados representam o percentual de proficiência por Disciplinas do Município selecionado em ({{strval($ano_same_selecionado)}}).
        </p>
