    ...
    <div class="card-deck" style="background-color: white;padding-top:16px;border: 1px solid white;">
        <div class="card text-center" style="box-shadow: 5px 5px 5px rgba(156,163,175);">
            ...
            <div class="card-header" style="text-align: justify;background-color: white; border-bottom:none;font-size:15px;color:black;font-weight:bold;">
                <i class="fa-solid fa-percent"></i> &emsp; @if($disciplina_selecionada[0]->id == 1) Temas @else Eixos/Temas @endif na Disciplina de {{$disciplina_selecionada[0]->desc}}
            </div>
            <!------------------------------------ Título Card ------------------->
            <div class="card-body" style="padding-top:0.5rem;padding-bottom:0.5rem;">
                <p class="card-text" style="font-size:13px;color:black;border-bottom:none;text-align:justify;font-weight:bold;">Seguem abaixo as Proficiências por @if($disciplina_selecionada[0]->id == 1) Tema @else Eixo/Tema @endif na Disciplina de {{$disciplina_selecionada[0]->desc}}</p>
                <!------------------------------------ Cards ------------------->
                @foreach ($dados_base_tema as $group)
                <div class="row justify-content-center" style="margin-top: -10px;">

                    @foreach ($group as $dados_base)
                    @foreach($legendas as $legenda)
                    @php
                    if($dados_base->percentual_tema >= $legenda->valor_inicial && $dados_base->percentual_tema <= $legenda->valor_final){
                        ...
                        <div class="col-md-3" style="margin-top:20px;border: 1px solid white;background-color:white;padding-left:0px;padding-right:0px;">
                            <div class="card text-center" style="background-color:{{$corFundo}};border: 1px solid #f0f8ff;box-shadow: 5px 5px 5px rgba(156,163,175);min-height: 130px;">
                                <div class="card-header" style="text-align: center;background-color:{{$corFundo}}; border-bottom:none;font-size:13px;font-weight:bold;color:{{$corLetra}};padding-bottom:0.1em;">
                                    {{$dados_base->nome_tema}}
                                </div>
                                <div class="card-body" style="padding-bottom:0.5em;padding-top:0.5em;">
                                    <h5 class="card-title" style="text-align: center;background-color:{{$corFundo}}; border-radius:50%;border-bottom:none;font-size:25px;color:{{$corLetra}};font-weight:bold;"><?php echo number_format($dados_base->percentual_tema, 0, '.', '') ?>%</h5>
                                </div>
                            </div>
                        </div>
                ...
                <p style="color:rgba(107,114,128);font-size: 13px;text-align:justify;margin-top:30px;">
                    * Os presentes dados representam o percentual de proficiência por @if($disciplina_selecionada[0]->id == 1) Temas @else Eixos/Temas @endif da Turma selecionda na Disciplina de {{$disciplina_selecionada[0]->desc}}.
                </p>
                <!------------------------------------ Legenda ------------------->
            ...
            <!------------------------------------ Navegação ------------------->
            <div class="card-footer text-muted" style="background-color: white;padding-top: 0em;padding-bottom: 0.3rem;border-top:none;text-align:justify;" id="tema_grafico">
                <div class="row justify-content-center">
                    <div class="col-md-6" style="background-color: white;border: 1px solid white;text-align:left;">
                        <a class=" btn btn-link" style="color:#f9821E;font-size:13px;text-decoration:none;" href="#turma">
                            Voltar para Turma &emsp;<i class="fa-solid fa-arrow-up-short-wide"></i>
                    ...
                    <div class="col-md-6" style="background-color: white;border: 1px solid white;text-align:right;">
                        <a class=" btn btn-link" style="color:#f9821E;font-size:13px;text-decoration:none;" href="#tema_grafico">
                            Gráfico Proficiência @if($disciplina_selecionada[0]->id == 1) Temas @else Eixos/Temas @endif na Disciplina de {{$disciplina_selecionada[0]->desc}}&emsp;<i class="fa-solid fa-arrow-down-short-wide"></i>
