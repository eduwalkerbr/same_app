    ...
    <div class="card-deck" style="background-color: white;padding-top:16px;border: 1px solid white;">
        <div class="card text-center" style="box-shadow: 5px 5px 5px rgba(156,163,175);">
            ...
            <div class="card-body" style="padding-top:0.5rem;padding-bottom:0rem;">
                            ...
                            <ol class="breadcrumb" style="background-color: white;border:none;color:#0046AD;padding: 0.1em 0.5em;">
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li><a class="dropdown-item" style="color:black;font-size: 13px;" href="{{ route('professor.exibirTurmaAno', ['id' => $turma_selecionada[0]->id, 'id_disciplina' => $disciplina_selecionada[0]->id, 'id_escola' => $escola_selecionada[0]->id, 'ano' => $ano_principal[0], 'ano_same' => $ano_same_selecionado]) }}">{{ $ano_principal[0]}}º Ano</a></li>
                                        @endforeach
                                    </ul>
                                </li>
                            </ol>
                ...
                <!------------------------------------ Legenda ------------------->
                <p style="color:black;font-size: 12px;text-align:right;margin-top:5px;margin-bottom:10;font-weight:bold;">Fonte: Dados oriundos de bases internas do SAME ({{strval($ano_same_selecionado)}}).</p>

            </div>
            <!------------------------------------ Navegação ------------------->
            <div class="card-footer text-muted" style="background-color: white;padding-top: 0em;padding-bottom: 0.3rem;border-top:none;text-align:justify;" id="habilidadeanodisciplina">
                <div class="row justify-content-center">
                    <div class="col-md-6" style="background-color: white;border: 1px solid white;text-align:left;">
                        <a class=" btn btn-link" style="color:#f9821E;font-size:13px;text-decoration:none;" href="#matematica">
                            Voltar para Gráfico Habilidades {{$disciplina_selecionada[0]->desc}} &emsp;<i class="fa-solid fa-arrow-up-short-wide"></i>
                    ...
                    <div class="col-md-6" style="background-color: white;border: 1px solid white;text-align:right;">
                        <a class=" btn btn-link" style="color:#f9821E;font-size:13px;text-decoration:none;" href="#habilidadeanodisciplina">
                            Gráfico Habilidades {{$disciplina_selecionada[0]->desc}} Ano &emsp;<i class="fa-solid fa-arrow-down-short-wide"></i>
