...
<body>
    <div id="app">
        ...
        <main class="py-4">
            <div class="row">
            @include('layouts/diretor.menulateral');    
    ...
    const configHabilidadeDisciplina = {
        ...
        options: {
            ...
            plugins: {
                title: {
                    display: true,
                    text: 'Proficiência por Habilidade na Disciplina de ' + '<?php echo $disciplina_selecionada[0]['desc'] ?>' + 'no ' + <?php echo $anos[0][0] ?> + 'º Ano',
                    font: {
                        size: 13,
                        family: 'tahoma',
                        weight: 'normal',
