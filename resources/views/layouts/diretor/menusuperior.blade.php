                    ...
                    <ul class="navbar-nav mr-auto">
                        ...
                        <a id="navbarDropdown" class="nav-link dropdown-toggle" href="{{ route('secretario.index') }}" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="font-size: 15px;color: black;" onmouseover='this.style.backgroundColor="#0046AD";this.style.color="white"' onmouseout='this.style.backgroundColor=" white";this.style.color="black"'>
                            ...
                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown" style="font-size: 15px;color: black;">
                                <a class="dropdown-item" href="{{ route('diretor_comparativo.exibirEscolaComparativo',['id' => $escola_selecionada[0]->id, 'id_municipio' => $municipio_selecionado[0]->id, 'id_disciplina' => $disciplina_selecionada[0]->id, 'sessao' => 'escola_comparativo']) }}" style="font-size: 15px;color: black;" onmouseover='this.style.backgroundColor="#0046AD";this.style.color="white"' onmouseout='this.style.backgroundColor=" white";this.style.color="black"'>
                                    Comparativos
                                </a>
                            </div>
                        </li>
                    ...
                    <ul class="navbar-nav ml-4">
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a class="dropdown-item" style="color:black;" href="{{ route('diretor.exibirEscola', ['id' => $escola_selecionada[0]->id, 'id_municipio' => $municipio_selecionado[0]->id, 'id_disciplina' => $disciplina_selecionada[0]->id, 'ano_same' => $ano_same->SAME]) }}">{{ $ano_same->SAME ?? ''}}</a></li>
                                @endforeach
                            </ul>
                        </li>
                    </ul>
                    <ul class="navbar-nav ml-4">
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a class="dropdown-item" style="color:black;" href="{{ route('diretor.exibirEscola', ['id' => $escola_selecionada[0]->id, 'id_municipio' => $municipio_selecionado[0]->id, 'id_disciplina' => $disciplina->id, 'ano_same' => $ano_same_selecionado]) }}">{{ $disciplina->desc ?? ''}}</a></li>
                                @endforeach
                            </ul>
                        </li>
                    </ul>
