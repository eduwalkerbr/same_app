                    ...
                    <div class="card-deck" style="background-color: white;padding-top:16px;border: 1px solid white;">
                        <div class="card text-center" style="box-shadow: 5px 5px 5px rgba(156,163,175);">
                            ...
                            <div class="card-body" style="padding-top:1rem;padding-bottom:0.5rem;background-color:white;">
                                ...
                                <p style="color:black;font-size: 12px;text-align:right;margin-top:0px;font-weight:bold;" id="graficoturma">Fonte: Dados oriundos de bases internas do SAME.</p>
                            </div>
                    ...
                    <div class="card-deck" style="background-color: white;padding-top:16px;border: 1px solid white;">
                        <div class="card text-center" style="box-shadow: 5px 5px 5px rgba(156,163,175);">
                            ...
                            <div class="card-body" style="padding-top:1rem;padding-bottom:0.5rem;background-color:white;">
                                ...
                                <button id="button_turma_disc_{{$label_turma_disc_item}}" onclick="manipularTurmaDisciplina('{{$label_turma_disc_item}}')" style="margin-right:5px;margin-top:0px;color:white;background-color:#f9821E;border-color:#f9821E;" class="btn btn-primary btn-sm"><i class="fa-solid fa-minus"></i> &ensp;{{$label_turma_disc_item}}</button>
                                @endforeach
                                <button id="" data-bs-toggle="modal" data-bs-target="#mod_turma_disc" onclick="" style="margin-left:100px;margin-top:5px;font-size:14px;font-weight:bold;" class="btn btn-outline-dark btn-sm"><i class="fa-solid fa-table-list"></i> &ensp; Dados Tabelados</button>
                                <p style="color:rgba(107,114,128);font-size: 13px;text-align:justify;margin-top:10px;">
                                ...
                                <p style="color:black;font-size: 12px;text-align:right;margin-top:0px;font-weight:bold;" id="graficohabilidade">Fonte: Dados oriundos de bases internas do SAME.</p>
                            </div>

                            @include('comparativo/diretor/content/modals.turma_disciplina')
                        ...
                        <div class="card text-center" style="box-shadow: 5px 5px 5px rgba(156,163,175);">
                                                ...
                                                <ol class="breadcrumb" style="background-color: white;border:none;color:#0046AD;padding: 0em 0em;">
                                                    ...
                                                    <li class="nav-item dropdown">
                                                        ...
                                                        @foreach($anos as $ano_principal)
                                                            <li><a class="dropdown-item" style="color:black;font-size: 13px;" href="{{ route('diretor_comparativo.exibirEscolaComparativoAno', ['id' => $escola_selecionada[0]->id,'id_municipio' => $municipio_selecionado[0]->id, 'id_disciplina' => $disciplina->id, 'ano' => $ano_principal[0], 'sessao' => 'graficohabilidade']) }}">{{ $ano_principal[0]}}º Ano</a></li>
                                                            @endforeach
                                                        </ul>
                                                    </li>
                            ...
                            <!--<div class="card-footer text-muted" style="background-color: white;padding-top: 0em;padding-bottom: 0.3rem;border-top:none;text-align:justify;margin-top:-15px;" id="fim">
                                <div class="row justify-content-center">
                                    <div class="col-md-7" style="background-color: white;border: 1px solid white;text-align:left;">
                                        <a class=" btn btn-link" style="color:#f9821E;font-size:13px;text-decoration:none;" href="#graficoturma">
                                        Anos Curriculares em {{$escola_selecionada[0]->nome}} na Disciplina de {{$disciplina_selecionada[0]->desc}} &emsp;<i class="fa-solid fa-arrow-up-short-wide"></i>
                                        </a>
                                    </div>
                                    <div class="col-md-5" style="background-color: white;border: 1px solid white;text-align:right;">
                                        <a class=" btn btn-link" style="color:#f9821E;font-size:13px;text-decoration:none;" href="#escola_comparativo">
