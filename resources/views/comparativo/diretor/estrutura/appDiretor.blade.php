                ...
                <div class="col-2 fixed-top">
                    <nav id="navbar-example3" class="h-100 flex-column align-items-stretch pe-4" style="margin-top:160px;margin-right:5px;">
                        <nav class="nav nav-pills flex-column" style="background-color:rgba(54, 162, 235, 0.2);">
                            <a id="link_escola_comparativo" onclick="manipularLink('escola_comparativo')" class="nav-link" href="#escola_comparativo" style="font-size:14px;font-weight:bold;color:#0046AD;border: 0.1em solid #0046AD;border-radius:0;border-bottom:none;padding-top:15px;padding-bottom:15px;">Disciplinas</a>
                            <a id="link_graficocurricular" class="nav-link" onclick="manipularLink('graficocurricular')" href="#graficocurricular" style="font-size:14px;font-weight:bold;color:#0046AD;border: 0.1em solid #0046AD;border-radius:0;border-bottom:none;padding-top:15px;padding-bottom:15px;">Ano Curricular por Disciplina</a>
                            ...
                            <a id="link_graficohabilidade" class="nav-link" onclick="manipularLink('graficohabilidade')" href="#graficohabilidade" style="font-size:14px;font-weight:bold;color:#0046AD;border: 0.1em solid #0046AD;border-radius:0;padding-top:15px;padding-bottom:15px;">Habilidades por Disciplina e Ano Curricular</a>
                        </nav>
                    </nav>
                </div>
