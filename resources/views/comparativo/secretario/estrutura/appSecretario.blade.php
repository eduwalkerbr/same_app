            ...
            <div class="row">
                <div class="col-2 fixed-top">
                    <nav id="navbar-example3" class="h-100 flex-column align-items-stretch pe-4" style="margin-top:160px;margin-right:5px;">
                        ...
                        <a id="link_municipio_comparativo" class="nav-link" onclick="manipularLink('municipio_comparativo')" href="#municipio_comparativo" style="font-size:14px;font-weight:bold;color:#0046AD;border: 0.1em solid #0046AD;border-radius:0;border-bottom:none;padding-top:15px;padding-bottom:15px;">Escolas</a>
                        <a id="link_graficoescoladisciplina" class="nav-link" onclick="manipularLink('graficoescoladisciplina')" href="#graficoescoladisciplina" style="font-size:14px;font-weight:bold;color:#0046AD;border: 0.1em solid #0046AD;border-radius:0;border-bottom:none;padding-top:15px;padding-bottom:15px;">Escolas por Disciplina</a>
                        <a id="link_graficodisciplina" onclick="manipularLink('graficodisciplina')" class="nav-link" href="#graficodisciplina" style="font-size:14px;font-weight:bold;color:#0046AD;border: 0.1em solid #0046AD;border-radius:0;border-bottom:none;padding-top:15px;padding-bottom:15px;">Disciplinas</a>
                        <a id="link_graficocurriculardisciplina" class="nav-link" onclick="manipularLink('graficocurriculardisciplina')" href="#graficocurriculardisciplina" style="font-size:14px;font-weight:bold;color:#0046AD;border: 0.1em solid #0046AD;border-radius:0;border-bottom:none;padding-top:15px;padding-bottom:15px;">Anos Curriculares por Disciplina</a>
                        <a id="link_graficotema" class="nav-link" onclick="manipularLink('graficotema')" href="#graficotema" style="font-size:14px;font-weight:bold;color:#0046AD;border: 0.1em solid #0046AD;border-radius:0;border-bottom:none;padding-top:15px;padding-bottom:15px;">Temas por Disciplina e Ano Curricular</a>
                        <a id="link_graficohabilidadeanodisciplina" class="nav-link" onclick="manipularLink('graficohabilidadeanodisciplina')" href="#graficohabilidadeanodisciplina" style="font-size:14px;font-weight:bold;color:#0046AD;border: 0.1em solid #0046AD;border-radius:0;padding-top:15px;padding-bottom:15px;">Habilidades por Disciplina e Ano Curricular</a>
                        </nav>
                    </nav>
                </div>
