...
<div class="container" style="padding-top: 20px;margin-top: 100px; margin-bottom: 140px;box-shadow: 5px 5px 5px rgba(0,0, 139);background-color:white;">
    <div class="row justify-content-center">
        <div class="col-md-10">
            <h4 style="font-weight: bolder; font-size: 18px; color: #f9821E; margin-bottom: 20px;text-align:center;">Solicitações de Registro</h4>
            <p style="color: black;font-size: 13px;font-weight: bold;">Seguem abaixo as solicitações de registro de usuário realizadas e que se encontram pendentes de avaliação.
                Os usuário em questão poderão realizar acesso ao sistema, contudo até que a avaliação seja finalizada, terão limitações de recursos que poderão acessar.
            </p>
        ...
        <div class="col-md-10" style="background-color: white;padding-top:13px;border: 1px solid white;">
            <div class="card text-center" style="box-shadow: 5px 5px 5px rgba(156,163,175);">
                <div class="card-header" style="text-align: justify;background-color: white; border-bottom:none;font-size:15px;color:rgba(0,0,139);font-weight:bold;">
                    <i class="fa-solid fa-users-gear"></i> &emsp; {{$solicitacao->email ?? ''}}
                </div>
