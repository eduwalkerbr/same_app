...
<div class="container" style="margin-top: 100px;">
  <div class="card text-center">
    <div class="card-body" style="background-color: #0046AD; color: white;box-shadow: 5px 5px 5px rgba(0,0, 139);">
      <h5 class="card-title">Lista de Disciplina</h5>
      <p class="card-text">Segue abaixo a lista de Disciplinas para Visualização e ou Edição.</p>
    </div>
  </div>
  @csrf
  <br>
  <table class="table responsive-md">
    ...
    <tbody>
      ...
      <tr>
        <th style="font-weight: normal;font-size:14px;" scope="row">{{$disciplina->id}}</th>
        <td style="font-weight: normal;font-size:14px;">{{$disciplina->desc}}</td>
        <td style="font-weight: normal; text-align:center;font-size:14px;">{{$disciplina->updated_at->format('d/m/Y H:i:s')}}</td>
        <td style="text-align:center;">
          <a href="{{ route('cadastro_disciplina') }}">
