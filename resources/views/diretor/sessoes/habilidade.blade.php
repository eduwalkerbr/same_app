<div class="row justify-content-center">
    <!------------------------------------ Card Habilidades na Disciplina por Ano ------------------->
    <div class="card-deck" style="background-color: white;padding-top:16px;border: 1px solid white;">
        <div class="card text-center" style="box-shadow: 5px 5px 5px rgba(156,163,175);">
            ...
            <div class="card-body" style="padding-top:0.5rem;padding-bottom:0.5rem;">
                            ...
                            <ol class="breadcrumb" style="background-color: white;border:none;color:#0046AD;padding: 0.1em 0.5em;">
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li><a class="dropdown-item" style="color:black;font-size: 13px;" href="{{ route('diretor.exibirEscolaAno', ['id' => $escola_selecionada[0]->id, 'id_municipio' => $municipio_selecionado[0]->id, 'id_disciplina' => $disciplina_selecionada[0]->id, 'ano' => $ano_principal[0], 'ano_same' => $ano_same_selecionado]) }}">{{ $ano_principal[0]}}º Ano</a></li>
                                        @endforeach
                                    </ul>
                                </li>
                ...
                @endforeach
                <p style="color:rgba(107,114,128);font-size: 13px;text-align:justify;margin-top:30px;">
                    * Os presentes dados representam o percentual de proficiência por Habilidades da Escola selecionada, na Diciplina de {{$disciplina_selecionada[0]->desc}} no {{$ano[0]}}º Ano.
                ...
                <div class="row justify-content-center">
                    <div class="col-md-6" style="background-color: white;border: 1px solid white;text-align:left;">
                        <a class=" btn btn-link" style="color:#f9821E;font-size:13px;text-decoration:none;" href="#graficoturmamatematica">
                            Voltar para Gráfico Turmas {{$disciplina_selecionada[0]->desc}} &emsp;<i class="fa-solid fa-arrow-up-short-wide"></i>
                    ...
                    <div class="col-md-6" style="background-color: white;border: 1px solid white;text-align:right;">
                        <a class=" btn btn-link" style="color:#f9821E;font-size:13px;text-decoration:none;" href="#matematica">
                            Gráfico Habilidades {{$disciplina_selecionada[0]->desc}} nos Anos&emsp;<i class="fa-solid fa-arrow-down-short-wide"></i>
