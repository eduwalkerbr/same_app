<div class="row justify-content-center">
    ...
    <div class="card-deck" style="background-color: white;padding-top:16px;padding-bottom:16px;border: 1px solid white;">
        <div class="card text-center" style="box-shadow: 5px 5px 5px rgba(156,163,175);">
            <!------------------------------------ Título Card Habilidade Selecionada Anos ------------------->
            ...
            <div class="card-body" style="padding-top:0.5rem;padding-bottom:0.5rem;">
                            ...
                            <ol class="breadcrumb" style="background-color: white;border:none;color:#0046AD;padding: 0.1em 0.5em;">
                                ...
                                <li class="nav-item dropdown nav-fill">
                                    ...
                                    <ul class="dropdown-menu navbar-nav-scroll" style="max-height:220px;">
                                        ...
                                        <li><a class="dropdown-item" style="color:black;font-size: 13px;" href="{{ route('diretor.exibirEscolaHabilidade', ['id' => $escola_selecionada[0]->id, 'id_municipio' => $municipio_selecionado[0]->id, 'id_disciplina' => $disciplina_selecionada[0]->id,'ano' => $ano[0],'id_habilidade' => $habilidade->id_habilidade, 'ano_same' => $ano_same_selecionado]) }}">
                ...
                @endforeach
                <p style="color:rgba(107,114,128);font-size: 13px;text-align:justify;margin-top:30px;">
                    * Os presentes dados representam o percentual de proficiência da Habilidade selecionada, na Disciplina de {{$disciplina_selecionada[0]->desc}} da presente Escola no transcorrer dos Anos.
                ...
                <!------------------------------------ Legenda ------------------->
                <p style="color:black;font-size: 12px;text-align:right;margin-top:10px;margin-bottom:10;font-weight:bold;">Fonte: Dados oriundos de bases internas do SAME ({{strval($ano_same_selecionado)}}).</p>
